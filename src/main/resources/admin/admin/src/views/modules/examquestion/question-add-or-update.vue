<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择测试模板" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择测试模板">
          <el-option
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择测试模板", trigger: "blur" }],
        questionname: [
